...
class MecanicoDAO {
    ...
    public function criar($nome,$cpf,$celular,$cep,$datanasc) {
        try {
           ...
           $this->conn->query("INSERT INTO MECANICO(MEC_NOME,MEC_CPF,MEC_CELULAR,MEC_CEP,MEC_DATANASC) values ('$nome','$cpf','$celular','$cep','$datanasc') ");
        } catch (Exception $e) {
    ...
    public function listar () {
            ...
            echo "<table>";
            echo "<tr><th>id</th><th>Nome</th><th>CPF</th><th>Celular</th><th>CEP</th><th>Data_Nasc</th><th>Deletar</th><th>Atualizar</th></tr>";
            while ($row = $result -> fetch_assoc()) {
                ...
                <td> 
                    <a href='atualizarMecanico.php?mec_id={$row['MEC_ID']}&mec_nome={$row['MEC_NOME']}&mec_cpf={$row['MEC_CPF']}&mec_celular={$row['MEC_CELULAR']}&mec_cep={$row['MEC_CEP']}&mec_datanasc={$row['MEC_DATANASC']}'><button type='button'>Atualizar</button></a>
                </tr>
                ";
            }       
    }
    ...
    public function atualizar($ID,$nomenovo,$cpfnovo,$celularnovo,$cepnovo,$datanascnova) {
        $this->conn->query("UPDATE MECANICO SET MEC_NOME = '$nomenovo', MEC_CPF = '$cpfnovo', MEC_CELULAR = '$celularnovo', MEC_CEP = '$cepnovo', MEC_DATANASC = '$datanascnova' WHERE MEC_ID = '$ID'");
    }
